    ...
    class Program
    {
        static void Main(string[] args)
        {
                                                        ...
                                                        MultiSubnetFailover=False;"))
            {
                ...
                //ADDED STORED PROCEDURES in (Programmability -> Stored Procedures)
                using (var updateCustomerCommand = new SqlCommand("UpdateCustomer", connection)) //"UpdateCustomer" is the procedure that is called in Stored Procedure.
                {
                    // Using System.Data;
